...
import MakhalHub from "../assets/makhalhub.png";
  ...
  const projects = [
    {
      ...
      description:
        "A robust Laravel application featuring role-based access control, multi-school management, payment workflows, result processing, and production deployment with SSL and domain configuration.",
      image: MakhalHub,
      demo: "https://makhalhub.com/",
      github: "https://github.com/Gbolahan-12/multischoolsys",
    },
    {
      title: "E-Commerce Website",
      description:
        "A full online shopping platform built with React, Laravel API, and TailwindCSS.",
      image: TradarPics,
    ...
    },
    {
      ...
      description:
        "A clean, animated e-commerce built with React and TailwindCSS.",
      image: HavestaPics,
    ...
    },
    {
      ...
      description:
        "A complete system with authentication, roles, courses, and results.",
      image: SchoolPics,
